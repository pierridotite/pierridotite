...
### Quick Focus
* **Current:** AI Engineer @ Capgemini (Multimodal RAG, VLM, LLM workflows for Industry & AgTech).
* **Research Interests:** GenAI evaluation, ML systems research, compiler-level autodiff, optimization semantics.
* **Languages:** Python, Rust, TypeScript, SQL, Java.
...
> **Terminal UI & Finance**
> Real-time terminal dashboard for crypto and stock market data featuring ASCII charts and dynamic styling.
> *Tech: Rust/Python, TUI.*

#### [CIFAR10-CompressAI](https://github.com/pierridotite/CIFAR10-CompressAI)
> **Computer Vision Research**
> Implementation of a Hybrid-Loss Autoencoder for image compression achieving 12.0x compression with 0.89 SSIM.
> *Tech: TensorFlow, Keras, Image Processing.*

---

<div align="center">
  <i>Piano player (10+ yrs) • Marathon Runner • Research-driven Engineering</i>
</div>
